...
export default function RulesPage({ onNext }) {
  return (
    <div className="min-w-80 mx-auto w-screen flex flex-col items-center bg-primary">
      <div className="max-w-md min-h-screen w-full flex flex-col justify-end p-6">
        <header>
          <Text as="h1" variant="heading" className="mb-12 text-white uppercase">
            Game Rules
          </Text>
        </header>
        ...
        <main className="flex flex-col">
          ...
          <Button arrow onClick={onNext}>START</Button>
        </main>
      </div>
    </div>
  );
